        ...
        <div class="my-auto">
            ...
            <form id="review-form" action="includes/review-helper.php" method="post">
                ...
                <div class="form-group" style="margin-top: 15px;">
                    ...
                    <textarea name="review" id="review-text" cols="50" rows="3" placeholder="Type review"></textarea>
                ...
                <div class="form-group">
                    <button class="btn btn-success" type="submit" name="review-submit" id="review-submit">Submit</button>
