    ...
    function preview(e) {
        if (e.files[0]) {
            ...
            reader.onload = function(e) {
                document.querySelector('#gallery-display').setAttribute('src', e.target.results);
            }
        ...
        <div class="my-auto">
            <form action="includes/gallery-helper.php" method="POST" enctype="multipart/form-data">
                <div class="form-group">
                    <img src="images/default.jpg" alt="gallery picture" onclick="triggered();" id="gallery-display">
