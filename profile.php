    ...
    function preview(e) {
        if (e.files[0]) {
            ...
            reader.onload = function(e) {
                document.querySelector('#prof-display').setAttribute('src', e.target.results);
            }
    ...
    <div class="h-50 center-me text-center">
        <div class="my-auto">
            <form action="includes/upload-helper.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <textarea name="bio" id="bio" cols="30" rows="10" placeholder="bio" style ="text-align: left;"></textarea>
                </div>
                <div class="form-group">
                    <button type="submit" name="prof-submit" class="btn btn-outline-success btn-lg btn-block">save</button>
                </div>
            </form>
        </div>
    </div>
