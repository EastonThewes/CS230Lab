            ...
            <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img class="d-block w-100" src="images/milkw.jpg" alt="First slide">
                    </div>
                    <div class="carousel-item">
                        <img class="d-block w-100" src="images/milkc.jpeg" alt="Second slide">
                    </div>
                    <div class="carousel-item">
                        <img class="d-block w-100" src="images/milks.jpeg" alt="Third slide">
                    </div>
                </div>
        ...
        <div class="h-40 center-me">
            ...
            <div class="my.auto">
                ...
                <form class="form-signin" action="includes/login-helper.php" method="post">
                    ...
                    <p clase="hint-text">Log on please and thank you</p>
